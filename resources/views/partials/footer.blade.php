    ...
    <div class="container-app py-10 flex flex-col md:flex-row items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <p class="text-xs text-fog-400 font-mono">
                © {{ date('Y') }} · Eduard Camilo Sánchez García · Hecho con Laravel + Tailwind
            </p>
        </div>
        <div class="flex items-center gap-5">
            <a href="https://github.com/EduardDeUnaGlobal" target="_blank" rel="noopener" class="text-fog-400 hover:text-white transition" aria-label="GitHub">
            ...
            <a href="mailto:{{ env('CONTACT_EMAIL') }}" class="text-fog-400 hover:text-white transition" aria-label="Email">
            ...
            <a href="{{ env('LINKEDIN_URL', '#') }}" target="_blank" rel="noopener" class="text-fog-400 hover:text-white transition" aria-label="LinkedIn">
                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
