<footer class="relative border-t border-white/5 mt-24">
    <div class="container-app py-10 flex flex-col md:flex-row items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            <div class="h-2 w-2 rounded-full bg-azure-400 animate-glow-pulse"></div>
            <p class="text-xs text-fog-400 font-mono">
                © {{ date('Y') }} · Eduard Camilo Sánchez García · Laravel + Tailwind
            </p>
        </div>
        <div class="flex items-center gap-1">
            <a href="https://github.com/ecamilodev"
               target="_blank" rel="noopener noreferrer"
               class="inline-flex h-11 w-11 items-center justify-center rounded-full text-fog-400 hover:text-white hover:bg-white/5 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 focus-visible:ring-offset-ink-950"
               aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/eduard-camilo-sanchez-garcia-651405335/"
               target="_blank" rel="noopener noreferrer"
               class="inline-flex h-11 w-11 items-center justify-center rounded-full text-fog-400 hover:text-white hover:bg-white/5 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 focus-visible:ring-offset-ink-950"
               aria-label="LinkedIn">
                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
