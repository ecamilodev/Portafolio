...
<section class="relative pt-40 pb-24 md:pt-56 md:pb-36 overflow-hidden">
    ...
    <div class="glow-blob bg-clay-300 h-80 w-80 -top-20 -left-10"></div>
    <div class="glow-blob bg-clay-200 h-96 w-96 top-40 -right-20"></div>
        ...
        <div class="grid md:grid-cols-[1fr_auto] gap-16 items-center">
            ...
            <div>
                ...
                <h1 class="font-display font-bold leading-[0.95] tracking-tight mb-7
                    ...
                    <span class="text-linen-900 block">Camilo</span>
                    <span class="text-clay-600 block">Sánchez</span>
                </h1>

                {{-- Rol --}}
                <p class="text-lg md:text-xl text-linen-700 font-medium mb-8">
                    {{ $profile['role'] }}
                </p>

                {{-- Contacto rápido --}}
                <div class="flex flex-wrap items-center gap-x-6 gap-y-2 mb-10 text-sm font-mono text-linen-600">
                    <a href="mailto:{{ $profile['email'] }}"
                       class="flex items-center gap-2 hover:text-clay-600 transition-colors duration-200">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="hidden sm:block w-px h-8 bg-linen-300 mx-1"></div>
                ...
                <div class="relative">
                    ...
                    <svg class="absolute pointer-events-none motion-safe:animate-spin"
                        ...
                        <defs>
                            <linearGradient id="sr" x1="0" y1="0" x2="1" y2="1">
                                <stop offset="0%"   stop-color="var(--color-clay-500)" stop-opacity="0"/>
                                <stop offset="50%"  stop-color="var(--color-clay-600)"/>
                                <stop offset="100%" stop-color="var(--color-clay-500)" stop-opacity="0"/>
                            </linearGradient>
                        </defs>
                    </svg>

                    {{-- Glow --}}
                    <div class="absolute -inset-4 rounded-full bg-gradient-to-br from-clay-600/10 to-clay-400/8 blur-2xl pointer-events-none"></div>
                    {{-- Borde gradiente --}}
                    <div class="absolute -inset-[3px] rounded-full bg-gradient-to-br from-clay-600/20 via-transparent to-clay-400/12 pointer-events-none"></div>
                    ...
                    <picture>
                        ...
                        <img src="{{ asset('img/perfil-opt.png') }}"
                             ...
                             loading="eager"
                             decoding="sync"
                             class="relative w-52 md:w-60 lg:w-72 aspect-square object-cover object-top rounded-full border border-linen-300 shadow-2xl">
                    </picture>

                    {{-- Letra "C" decorativa --}}
                    <div class="absolute -bottom-2 -right-2 h-12 w-12 rounded-full
                                bg-gradient-to-br from-clay-500 to-clay-600
                                flex items-center justify-center
                                font-display font-bold text-white text-xl
                                shadow-md shadow-clay-600/25 border-2 border-linen-100">
                        C
                    </div>
                </div>
            </div>
...
<section id="sobre-mi" class="py-32 relative">
    <div class="container-app">
        ...
        <div class="grid md:grid-cols-[1fr_auto] gap-10 items-start mb-12">
            ...
            <dl class="space-y-3" data-reveal data-delay="80">
                ...
                <div class="data-row">
                    ...
                    <dd class="data-value font-semibold text-clay-600">Steps Consulting Corp</dd>
                </div>
                <div class="data-row">
                ...
                <div class="data-row">
                    ...
                    <dd class="data-value">
                        <a href="mailto:{{ $profile['email'] }}"
                           class="text-clay-600 hover:text-clay-500 transition-colors duration-200">
                            {{ $profile['email'] }}
                        </a>
                    </dd>
                </div>
                <div class="data-row">
                    ...
                    <dd class="data-value flex items-center gap-2">
                        <span class="relative flex h-2 w-2 flex-shrink-0" aria-hidden="true">
                            <span class="absolute inline-flex h-full w-full rounded-full bg-clay-600 opacity-75 motion-safe:animate-ping"></span>
            ...
            <div class="flex justify-center" data-reveal data-delay="160">
                <div class="relative">
                    <div class="absolute -inset-2 rounded-2xl bg-gradient-to-br from-clay-600/8 to-clay-400/5 blur-xl pointer-events-none"></div>
                    <div class="absolute -inset-px rounded-2xl bg-gradient-to-br from-clay-600/15 via-transparent to-clay-400/10 pointer-events-none"></div>
                    <picture>
                        <source srcset="{{ asset('img/perfil.webp') }}" type="image/webp">
                        <img src="{{ asset('img/perfil-opt.png') }}"
                             alt="Camilo Sánchez"
                             loading="lazy"
                             decoding="async"
                             class="relative w-40 sm:w-44 md:w-52 aspect-[3/4] object-cover object-top rounded-2xl border border-linen-300 shadow-xl">
                    </picture>
                </div>
            </div>
        </div>
        ...
        {{-- Hechos --}}
        <div class="border-t border-linen-200" data-reveal data-delay="240">
            <div class="flex gap-8 items-baseline py-5 border-b border-linen-200">
                <span class="font-display text-3xl font-bold text-linen-900 w-20 flex-shrink-0 tabular-nums">4+</span>
                <span class="text-linen-700 text-sm">años en producción, plataformas reales con usuarios reales</span>
            </div>
            <div class="flex gap-8 items-baseline py-5 border-b border-linen-200">
                <span class="font-display text-3xl font-bold text-linen-900 w-20 flex-shrink-0 tabular-nums">5+</span>
                <span class="text-linen-700 text-sm">proyectos clave: e-commerce, apps móviles, APIs REST</span>
            </div>
            <div class="flex gap-8 items-baseline py-5">
                <span class="font-display text-3xl font-bold text-clay-600 w-20 flex-shrink-0">CO·PR</span>
                <span class="text-linen-700 text-sm">remoto; experiencia en Colombia y Puerto Rico</span>
            </div>
        </div>
...
<section id="experiencia" class="py-32 relative">
    <div class="container-app">
        <div class="mb-20 max-w-2xl" data-reveal>
            ...
            <p class="text-linen-600 leading-relaxed">
        ...
        <div class="relative">
            ...
            <div class="absolute left-3 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-clay-600/30 via-clay-500/15 to-transparent"></div>

            <div class="space-y-12">
                @foreach($experience as $i => $exp)
                    <div class="relative grid md:grid-cols-2 gap-8 items-start" data-reveal>
                        {{-- Punto del timeline --}}
                        <div class="absolute left-3 md:left-1/2 -translate-x-1/2 top-2 h-3 w-3 rounded-full bg-gradient-to-br from-clay-500 to-clay-600 ring-4 ring-linen-100 z-10"></div>
                        ...
                        <div class="ml-10 md:ml-0 {{ $i % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:col-start-2 md:pl-12' }}">
                            <div class="card inline-block w-full text-left">
                                <p class="font-mono text-xs text-clay-600 mb-2">{{ $exp['period'] }}</p>
                                <h3 class="font-display text-xl text-linen-900 mb-1">{{ $exp['role'] }}</h3>
                                <p class="text-sm text-linen-700 mb-1">{{ $exp['company'] }}</p>
                                <p class="text-xs text-linen-500 mb-4 font-mono">{{ $exp['location'] }}</p>
                                <ul class="space-y-2 text-sm text-linen-700">
                                    @foreach($exp['highlights'] as $h)
                                        <li class="flex gap-2">
                                            <span class="text-clay-600 mt-1">▸</span>
                                            <span>{{ $h }}</span>
                                        </li>
                                    @endforeach
                                </ul>
        ...
        <div class="grid md:grid-cols-2 gap-6">
            @foreach($education as $edu)
                <div class="card" data-reveal>
                    <p class="font-mono text-xs text-clay-600 mb-2">{{ $edu['period'] }}</p>
                    <h3 class="font-display text-xl text-linen-900 mb-1">{{ $edu['title'] }}</h3>
                    <p class="text-sm text-linen-700 mb-3">{{ $edu['institution'] }}</p>
                    <p class="text-sm text-linen-600 leading-relaxed">{{ $edu['description'] }}</p>
                </div>
            @endforeach
        </div>
    </div>
                   ...
                   data-reveal data-delay="{{ $loop->index * 80 }}">
                    <article class="card cursor-pointer relative overflow-hidden h-full transition-transform duration-300 group-hover:-translate-y-1">
                        ...
                        <div class="relative flex items-start justify-between mb-4">
                            <h3 class="font-display text-2xl text-linen-900 group-hover:text-clay-600 transition-colors duration-200">
                                {{ $project['name'] }}
                            </h3>
                        ...
                        <p class="text-sm font-medium text-linen-700 mb-3 relative">{{ $project['tagline'] }}</p>
                        <p class="text-sm text-linen-600 mb-5 leading-relaxed relative">{{ $project['description'] }}</p>
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-linen-200 relative">
                            <span class="text-xs font-mono text-linen-500">{{ $project['role'] }}</span>
                            <span class="text-xs text-linen-600 group-hover:text-clay-600 transition flex items-center gap-1">
                                Ver más
...
<section id="skills" class="py-32 relative">
    <div class="container-app">
        ...
        <div class="divide-y divide-linen-300 border-t border-linen-200">
            @foreach($skills as $category => $items)
                <div class="grid sm:grid-cols-[10rem_1fr] gap-x-10 gap-y-3 py-6 items-start" data-reveal>
                    <h3 class="font-mono text-xs uppercase tracking-widest text-linen-500 pt-0.5">{{ $category }}</h3>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach($certifications as $cert)
                <div class="card !p-0 flex flex-col overflow-hidden" data-reveal>
                    {{-- Vista previa --}}
                    <div class="w-full aspect-[16/9] overflow-hidden border-b border-linen-300 bg-linen-100">
                        <picture>
                    ...
                    <div class="p-5 flex flex-col flex-1">
                        <h3 class="font-display text-sm text-linen-900 mb-1 leading-snug">{{ $cert['name'] }}</h3>
                        <p class="text-xs text-linen-600 mb-3">{{ $cert['issuer'] }}</p>
                        <div class="flex items-center gap-3 mb-4">
                            <span class="text-xs font-mono text-clay-600">{{ $cert['year'] }}</span>
                            <span class="text-linen-400">·</span>
                            <span class="text-xs font-mono text-linen-600">{{ $cert['hours'] }}</span>
                        </div>

                        <div class="mt-auto pt-4 border-t border-linen-200">
                            <a href="{{ asset($cert['pdf']) }}" target="_blank"
                               class="flex items-center gap-2 text-sm text-linen-700 hover:text-linen-900 transition group">
                                <svg class="h-4 w-4 text-clay-600 group-hover:text-clay-500 transition flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="divide-y divide-linen-300 border-t border-linen-200">
            @foreach($aiTools as $tool)
                <div class="grid sm:grid-cols-[1fr_2fr] gap-x-10 gap-y-2 py-8 items-start" data-reveal>
                    <h3 class="font-display text-xl text-linen-900">{{ $tool['name'] }}</h3>
                    <p class="text-linen-600 text-sm leading-relaxed">{{ $tool['use'] }}</p>
                </div>
            @endforeach
        </div>
    </div>
...
<section id="contacto" class="py-32 relative">
    <div class="container-app">
        <div class="card relative overflow-hidden !p-10 md:!p-14" data-reveal>
            <div class="absolute -top-20 -right-20 h-60 w-60 rounded-full bg-clay-300 blur-3xl opacity-20"></div>
            <div class="absolute -bottom-20 -left-20 h-60 w-60 rounded-full bg-clay-200 blur-3xl opacity-15"></div>
            ...
            <div class="relative grid md:grid-cols-2 gap-10">
                <div>
                    ...
                    <p class="text-linen-600 mb-8 leading-relaxed">
                    ...
                    <div class="space-y-3">
                        <a href="mailto:{{ $profile['email'] }}"
                           class="flex items-center gap-3 text-linen-700 hover:text-linen-900 transition-colors duration-200 group">
                            <span class="h-10 w-10 rounded-xl bg-linen-100 border border-linen-300 flex items-center justify-center group-hover:bg-clay-600/8 group-hover:border-clay-600/30 transition-colors duration-200">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l9 6 9-6M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                </svg>
                            </span>
                ...
                <form action="{{ route('contact.send') }}" method="POST" class="space-y-4">
                    ...
                    @if(session('success'))
                        <div class="rounded-lg border border-clay-600/25 bg-clay-600/8 p-3 text-sm text-clay-600">
                            {{ session('success') }}
                        </div>
                    @endif
