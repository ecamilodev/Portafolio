...
<section class="pt-32 pb-24 relative">
    <div class="container-app max-w-3xl">
        <a href="{{ route('projects') }}" class="text-sm text-fog-400 hover:text-white transition inline-flex items-center gap-2 mb-10">
        ...
        <p class="text-lg text-fog-300 mb-8">{{ $project['tagline'] }}</p>

        <div class="prose prose-invert max-w-none mb-8">
            <p class="text-fog-300 leading-relaxed">{{ $project['description'] }}</p>
        </div>

        <div class="grid sm:grid-cols-2 gap-6 mb-10">
            <div>
                <p class="font-mono text-xs uppercase tracking-wider text-fog-400 mb-2">Rol</p>
                <p class="text-white">{{ $project['role'] }}</p>
            </div>
            <div>
                <p class="font-mono text-xs uppercase tracking-wider text-fog-400 mb-2">Stack</p>
